...
Once all Exercises have been completed, render the document one last time. Look over the .html document (in the Viewer pane) to make sure all your answers are visible and formatted as you intended.

To submit this assignment, you need to upload the .html file to the relevant Week 3 assignment on Canvas.
